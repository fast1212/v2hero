...
RUN apk add --no-cache --virtual .build-deps ca-certificates curl \
 ...
 && unzip v2ray.zip \
 && mv /v2raybin/v2ray-$VER-linux-64/v2ray /v2raybin/ \
 && mv /v2raybin/v2ray-$VER-linux-64/v2ctl /v2raybin/ \
 && mv /v2raybin/v2ray-$VER-linux-64/geoip.dat /v2raybin/ \
 && mv /v2raybin/v2ray-$VER-linux-64/geosite.dat /v2raybin/ \
